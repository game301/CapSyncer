          ...
          {activeEntity === "tasks" && (
            <>
              ...
              <Input
                label="Priority"
                name="priority"
                defaultValue={(editingEntity as TaskItem)?.priority || "Medium"}
              />
              <Input
                label="Status"
                name="status"
    ...
    <div className="space-y-6">
      ...
      {activeTab === "coworkers" && (
        <div className="space-y-4">
          ...
          <Table
            data={coworkers}
            onRowClick={(c) => router.push(`/coworkers/${c.id}`)}
            columns={[
            ...
            emptyMessage="No team members yet. Click 'Add Coworker' to get started."
          />
        </div>
      )}
      ...
      {activeTab === "assignments" && (
        <div className="space-y-4">
          ...
          <Table
            data={assignments}
            onRowClick={(a) => router.push(`/assignments/${a.id}`)}
            columns={[
              {
                header: "Coworker",
                accessor: (a) =>
                  coworkers.find((c) => c.id === a.coworkerId)?.name || "N/A",
              },
              {
                header: "Task",
                accessor: (a) =>
            ...
            emptyMessage="No assignments yet. Click 'Add Assignment' to get started."
          />
        </div>
      )}
    </div>
